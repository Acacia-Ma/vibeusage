...
export async function getPublicVisibilityState({ edgeClient, userId }) {
...
export async function setPublicVisibilityState({ edgeClient, userId, enabled, nowIso }) {
