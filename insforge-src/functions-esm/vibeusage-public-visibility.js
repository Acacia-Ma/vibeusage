...
import { handleOptions, json, readJson } from "./shared/http.js";
import {
  getPublicVisibilityState,
  setPublicVisibilityState,
} from "./shared/public-visibility.js";
import { withRequestLogging } from "./shared/logging.js";

export default withRequestLogging("vibeusage-public-visibility", async function (request) {
